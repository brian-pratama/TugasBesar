 ...
 * @author Brian
 */
public class MenuPetugasView extends javax.swing.JFrame {

    /**
     * Creates new form MenuAnggota
     */
    public MenuPetugasView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPetugasView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPetugasView().setVisible(true);
            }
        });
    }
