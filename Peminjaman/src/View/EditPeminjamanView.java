 ...
 */
public class EditPeminjamanView extends javax.swing.JFrame {

    /**
     * Creates new form EditPeminjaman
     */
    public EditPeminjamanView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Edit Barang Peminjaman");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPeminjamanView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPeminjamanView().setVisible(true);
            }
        });
    }
